...
<head>
    ...
    <!-- Title -->
    <title>NextPromise-AboutUs</title>
                            ...
                            <ul class="nav nav-tabs mb-50" id="mona_modelTab" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" id="tab2" data-toggle="tab" href="#tab-2" role="tab"
                                        aria-controls="tab-2" aria-selected="false"> ANALYSIS</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="tab3" data-toggle="tab" href="#tab-3" role="tab"
                                        aria-controls="tab-3" aria-selected="false">STRATEGY</a>
                                </li>
                            </ul>
                        </div>
                            ...
                            <div class="tab-content" id="mona_modelTabContent">
                                <div class="tab-pane fade show active" id="tab-1" role="tabpanel"
                                    ...
                                    <div class="tab-content-text">
                                        ...
                                        <p>At vero eos et accusam et justo duo dolores et ea rebum. Stet gubergren no
                                            sea takimata sanctus est Lorem ipsum dolor sit amet ipsumlor eut consetetur
                                            sadipscing elitr, sed diam nonumy eirmod tempor invidunt labore et dolore
                                            magna liquyam erat.</p>
                                ...
                                <div class="tab-pane fade" id="tab-3" role="tabpanel" aria-labelledby="tab3">
                                    ...
                                    <div class="tab-content-text">
                                        <p>At vero eos et accusam et justo duo dolores et ea rebum. Stet gubergren no
                                            sea takimata. Lorem ipsum dolor sit amet, consetetur sadipscing esed diam
                                            nonumy eirmod tempor invidunt ut labore et dolore magna.</p>
                                        <p>sanctus est Lorem ipsum dolor sit amet ipsumlor eut consetetur sadipscing
                                            elitr, sed diam nonumy eirmod tempor invidunt labore et dolore magna liquyam
                                            erat.</p>
                                        <a href="#" class="btn uza-btn mt-30">Get In Touch</a>
                                    </div>
                                </div>
                ...
                <div class="col-12 col-lg-6">
                    <div class="choose-us-content mb-80">
                        <div class="section-heading mb-4">
                            <h2>Why Choose Us</h2>
                            <p>We’re Your Partner in Your Future</p>
                        </div>
                        <ul>
                ...
                <div class="col-12 col-lg-4">
                    <div class="cta-content mb-80">
                        <div class="call-now-btn">
                            <a href="#"><span>Call us now:</span> (+91) 1234 5678</a>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="testimonial-slides owl-carousel">
                        ...
                        <div class="single-testimonial-slide d-flex align-items-center">
                            ...
                            <div class="testimonial-content">
                                <h4>“NextPromise Ltd’s ranking has gone up so much from the great work that your team
                                    has
                                    done and our brand get organic sales consistently from your efforts. We are happy
                                    that the results of your efforts were lasting and profitable.”</h4>
                                <!-- Ratings -->
                                <div class="ratings">
                                    <i class="icon_star"></i>
                                    <i class="icon_star"></i>
                                ...
                                <div class="author-info">
                                    <h5>Saurabh Singh <span>- CEO NextPromise</span></h5>
                                </div>
                                <!-- Quote Icon -->
            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="single-cf-area d-flex align-items-center mb-80">
                        <h2><span class="counter">889</span></h2>
                        <div class="cf-text">
                            <h6>Total<br>Deliveries</h6>
                        </div>
                ...
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="single-cf-area d-flex align-items-center mb-80">
                        <h2><span class="counter">920</span></h2>
                        <div class="cf-text">
                            <h6>Happy<br>Pateints</h6>
                        </div>
