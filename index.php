                    ...
                    <div class="classy-menu">
                        ...
                        <div class="classynav">
                            <ul id="nav">
                                ...
                                <li><b style="font-size: 1.2rem;">
                                <?php if(isset($_SESSION['username'])): ?>
                                    Welcome <span style="color: #3BAFBD"><?php echo $_SESSION['username']; ?> !!</span>
                                <?php endif; ?></b>
                                </li>
                            </ul>
                            ...
                            <div class="login-register-btn mx-3">
                                <a href="./registration/login.php"><span style="color: #1583E9;"> Login/Register</span></a>
                            </div>
                            <?php endif; ?>
                        ...
                        <div class="row h-100 align-items-center">
                            ...
                            <div class="col-12 col-md-6">
                                <div class="welcome-text">
                                    <h2 data-animation="fadeInUp" data-delay="100ms">NextPromise makes your <br> biz
                                        <span>greater</span></h2>
                                    <h5 data-animation="fadeInUp" data-delay="400ms">We love to take "care" using
                                        Digital Platforms Technology</h5>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-12 col-md-6">
                    <div class="about-us-content mb-80">
                        <h2>We're a Team of Doctors &amp; Personal Care</h2>
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        <div class="section-heading text-center">
                            ...
                            <p>Sayings from our top customers, what they think.</p>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="testimonial-slides owl-carousel">
                            ...
                            <div class="single-testimonial-slide d-flex align-items-center">
                                ...
                                <div class="testimonial-content">
                                    <h4>“NextPromise Ltd’s ranking has gone up so much from the great work that your
                                        team
                                        has done and our brand get organic sales consistently from your efforts. We are
                                        happy that the results of your efforts were lasting and profitable.”</h4>
                                    <!-- Ratings -->
                                    <div class="ratings">
                                        <i class="icon_star"></i>
                                        <i class="icon_star"></i>
                                    ...
                                    <div class="author-info">
                                        <h5>Mayank Soni <span>- CEO NextPromise</span></h5>
                                    </div>
                                    <!-- Quote Icon -->
            ...
            <div class="row">
                ...
                <div class="col-12">
                    <div class="section-heading text-center">
                        ...
                        <p>Check our latest blogs related to Healthcare and Medical Services</p>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-4">
                    <div class="single-blog-post bg-img mb-80" style="background-image: url(./img/bg-img/8.jpg);">
                        ...
                        <div class="post-content">
                            <span class="post-date"><span>23</span> August, 2019</span>
                            <a href="#" class="post-title">Precautionary measures taken during pregnancy</a>
                ...
                <div class="col-12 col-lg-4">
                    <div class="single-blog-post bg-img mb-80" style="background-image: url(./img/bg-img/9.jpg);">
                        <!-- Post Content -->
                        <div class="post-content">
                            <span class="post-date"><span>13</span> December, 2019</span>
                            <a href="#" class="post-title">Weekly diet chart follow during pregnancy</a>
                            <p>Lorem ipsum dolor sit amet, consetetur sadipscing esed diam nonumy eirmod tempor invidunt
                                ut</p>
                            <a href="#" class="read-more-btn">Read More <i class="arrow_carrot-2right"></i></a>
                        </div>
                ...
                <div class="col-12 col-lg-4">
                    <div class="single-blog-post bg-img mb-80" style="background-image: url(./img/bg-img/10.jpg);">
                        <!-- Post Content -->
                        <div class="post-content">
                            <span class="post-date"><span>08</span> Jan, 2020</span>
                            <a href="#" class="post-title">Health care VS Personal care</a>
                            <p>Lorem ipsum dolor sit amet, consetetur sadipscing esed diam nonumy eirmod tempor invidunt
                                ut</p>
                            <a href="#" class="read-more-btn">Read More <i class="arrow_carrot-2right"></i></a>
                        </div>
